                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" id="shop_number" name="shop_number" value="{{ old('shop_number') }}" class="form-control @error('shop_number') is-invalid @enderror" placeholder="Shop number">
                                @error('shop_number')
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" id="floor_number" name="floor_number" value="{{ old('floor_number') }}" class="form-control @error('floor_number') is-invalid @enderror" placeholder="Floor">
                                @error('floor_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" id="complex" name="complex" value="{{ old('complex') }}" class="form-control" placeholder="Complex">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="number" class="form-control @error('rent') is-invalid @enderror" min="1" value="{{ old('rent') }}" name="rent" placeholder="Rent">
