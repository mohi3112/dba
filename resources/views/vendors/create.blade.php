                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" id="father_first_name" name="father_first_name" class="form-control" placeholder="Father's first name">
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="father_last_name">father's last name</label>
                            <div class="input-group input-group-merge">
                                <input type="text" id="father_last_name" name="father_last_name" class="form-control" placeholder="Father's last name">
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input class="form-control" type="date" name="dob" value="" id="">
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <textarea class="form-control" name="residence_address" placeholder="Residence address"></textarea>
                        </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="location_id" class="select2 form-select">
                                ...
                                <option value="{{$lawyerId}}">{{$location}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3 col-md-6">
