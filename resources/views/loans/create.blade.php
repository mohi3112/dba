@extends('layouts.app')
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Loans /</span> Add Loan</h4>

<form method="POST" action="{{ route('loan.store') }}" id="formLoan">
    @csrf
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <select id="userDropdown" name="employee_id" class="form-control form-select user-select">
                                ...
                                <option value="{{$ky}}" @if(old('employee_id')==$ky) selected @endif>{{$employee}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input class="form-control @error('loan_amount') is-invalid @enderror" type="number" name="loan_amount" value="{{ old('loan_amount') }}">
                            </div>
                            @error('loan_amount')
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input class="form-control @error('tenure_months') is-invalid @enderror" type="text" name="tenure_months" value="{{ old('tenure_months') }}">
                            </div>
                            @error('tenure_months')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input class="form-control @error('emi_amount') is-invalid @enderror" type="text" name="emi_amount" value="{{ old('emi_amount') }}">
                            </div>
                            @error('emi_amount')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select id="userDropdown" name="status" class="form-control form-select">
                                ...
                                <option value="{{$ky}}" @if(old('status')==$ky) selected @endif>{{$status}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
