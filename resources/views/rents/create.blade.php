@extends('layouts.app')
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Rents /</span> Add Rent</h4>

<form method="POST" action="{{ route('rent.store') }}" id="formRent">
    @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input id="rent_amount" class="form-control @error('rent_amount') is-invalid @enderror" type="number" name="rent_amount" value="{{ old('rent_amount') }}">
                            </div>
                            @error('rent_amount')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input class="form-control @error('renewal_date') is-invalid @enderror" type="date" name="renewal_date" value="{{ old('renewal_date') }}">
                            </div>
                            @error('renewal_date')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
