            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- <div class="form-group row">
                            <label for="designation" class="col-md-4 col-form-label text-md-right">{{ __('Designation / User Type') }}</label>
                            ...
                            <div class="col-md-6">
                                <select id="designation" name="designation" class="select2 form-select">
                                    ...
                                    @php if($key == \App\Models\User::DESIGNATION_PRESIDENT) continue; @endphp
